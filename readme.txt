...
* [Support](https://huge-it.com/contact-us/)
* [Forum](https://wordpress.org/support/plugin/lightbox)
* [Github Project](https://github.com/Huge-IT/lightbox)
...
Plugin is highly adaptive. It adapts to the type of device displaying the page. This very important feature creates mobile-friendly content of your website.

### 5 Views

Make your images popup more perfect using different types. They are 5 nice types. So you have ability to fit the design to the design of your website.

### Customization Settings

Plugin offers a powerful selection of Customization’s, available as in free and pro version.

If you’re running free version and would like to review the premium offer, navigate to General Options to see all of them.

### Youtube Popup

If you include any YouTube video link in your website, then plugin can also work with that link. Watch your videos in pleasant way.

### Vimeo Popup

Besides YouTube you can make Vimeo link work with Lightbox. All your vimeo video links will be automatically displayed.
...
1.  WordPress - Demo image
2.  WordPress - Demo image
3.  WordPress - Demo Vimeo
4.  WordPress - Demo Youtube
5.  WordPress - Demo Vimeo
6.  WordPress - Demo Admin
...
= How to see the title of the image? =

*  In order to add name to your image and see it. 
*  Add attribute title=”X” in <a></a> tag of image code, where X is the name, 
*  Set “show the title” from Options
...
*  For installing the plugin do the following: Install the zip file | Plugins > add new > upload plugin. When you activate the Plugin it will automatically open  your images.


= How may I use Vimeo links to display? =
...
* 2) We have added zooming option with percentage support and details.

= 2.0.9 =
* Option effects (when you open the image/video or close).
...
= 2.0.6 =
* 1) We have added an option to add borders.
...
= 2.0.4 =
* 1) We have added thumbnails functionality.
* 2) We have added an URL option for Watermark.

= 2.0.3 =
* 1) We have added a full width option.
...
* 2) We have added an option to set the position of the titles.
...
* 3) Made some style changes in the views.
...
= 1.6.2 =
*  Front end bug has been fixed in macbook safari browser.
...
To add a lightbox in your website you just need to install plugin and its done.

### Step 2. Inserting Created
...
### Step 3 Use Both images and Videos.

Except images you also can insert youtube or vimeo link to show your videos.
...
*  Style. choose the style of your popup.
